...
public class Token
{
  ...
  public Integer column; // on which column of the source file this token appears
  ...
  public Token(Kind kind, Integer lineNum, Integer column, String lexeme)
  {
    this(kind, lineNum, column);
    this.lexeme = lexeme;
  }
