...
public class Ast
{
  ...
  public static class Class
  {
    ...
    public static class ClassSingle extends T
    {
      ...
      public String class_gc_map; // gc map for a class
      ...
      public void get_gc_map()
      {
    	for(Tuple t : decs)
    	{
    	  if (t.type.toString() == "@int")
    	  {
    		class_gc_map += "0";
    	  }
    	  else
  ...
  public static class Vtable
  {
    ...
    public static class VtableSingle extends T
    {
      ...
      public String class_gc_map; // class gc map which is a bit-vector specifying the number of fields this class has
      ...
      public VtableSingle(String id, ArrayList<codegen.C.Ftuple> ms, String class_gc_map)
      {
        this.id = id;
        this.ms = ms;
        this.class_gc_map = class_gc_map;
      }
