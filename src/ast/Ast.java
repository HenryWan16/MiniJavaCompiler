...
public class Ast {
	...
	public static class Type {
		...
		public static class Boolean extends T {
			...
			public Boolean(int line, int column) {
				this.line = line;
				this.column = column;
			}
		...
		public static class ClassType extends T {
			...
			public ClassType(String id, int line, int column) {
				this.id = id;
				this.line = line;
				this.column = column;
			}
		...
		public static class IntArray extends T {
			...
			public IntArray(int line, int column)
			{
				this.line = line;
				this.column = column;
			}
	...
	public static class Dec {
		...
		public static class DecSingle extends T {
			...
			public DecSingle(Type.T type, String id, int line, int column) {
				this.type = type;
				this.id = id;
				this.line = line;
				this.column = column;
	...
	public static class Exp {
		...
		public static class Add extends T {
			...
			public Add(T left, T right, int line, int column) {
				this.left = left;
				this.right = right;
				this.line = line;
				this.column = column;
		...
		public static class And extends T {
			...
			public And(T left, T right, int line, int column) {
				this.left = left;
				this.right = right;
				this.line = line;
				this.column = column;
		...
		public static class ArraySelect extends T {
			...
			public ArraySelect(T array, T index, int line, int column) {
				this.array = array;
				this.index = index;
				this.line = line;
				this.column = column;
		...
		public static class Call extends T {
			...
			public Call(T exp, String id, java.util.LinkedList<T> args, int line, int column) {
				this.exp = exp;
				this.id = id;
				this.args = args;
				this.type = null;
